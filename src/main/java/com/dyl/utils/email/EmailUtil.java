...
public class EmailUtil {
    ...
    public static void sendMsg(String receiveMailAccount, MailForm mail) throws Exception {
     ...
     * @throws Exception
     */
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, MailForm mail)
            throws Exception {
        // 1. 创建一封邮件
